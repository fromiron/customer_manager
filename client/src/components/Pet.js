...
import {API_SERVER, UPLOAD, SERVER} from './dotEnv'
...
const petDefaultImg = UPLOAD + 'hana.png'
...
function Pet(props) {
    ...
    const onSubmit = data => {
        Axios.post(API_SERVER + '/pets/' + pet.petId + '/update', {
            headers: {
    ...
    return (<>
        ...
        <TableRow>
            ...
            <TableCell className='alignCenter'>
                <PetProfile src={pet.petImg !== null ? `${SERVER + pet.petImg}` : petDefaultImg}/>
            </TableCell>
                ...
                <PetUpdateFormWrapper>
                    <PetFormInnerWrapper>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <AlignCenter>
                                <PetProfileBig src={`${SERVER + pet.petImg}`}/>
                            </AlignCenter>
                            <Divider>
                                <div>
                                    <FormRow>
